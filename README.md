...
[![Followers](assets/followers.svg?v=2)](https://github.com/PerinbaBuilds?tab=followers)
...
<img src="assets/contribution-graph.svg" alt="Perinba Athiban's contribution graph" width="100%" />
...
| **TradeWatch** | Big-data trade-surveillance engine — Kafka → FastAPI for sub-10ms anomaly alerts (spoofing, wash trades, price/volume spikes) via Z-Score + Isolation Forest, with a Spark + Hadoop (HDFS/MapReduce) layer for distributed detection and backtesting; ~96% recall at <1% false alarms | Python, Kafka, FastAPI, Spark, Hadoop | [Code](https://github.com/PerinbaBuilds/TradeWatch) |
...
| **Coinsight** | Cross-platform personal finance tracker — per-category budgets, income/expense logging, savings goals, recurring bills, a financial-health score, and an **AI financial advisor** (Grok / xAI) that answers purchase/loan/investment decisions from your real data | Flutter, Supabase, Grok (xAI) | [Code](https://github.com/PerinbaBuilds/Coinsight) · [Demo](https://perinbabuilds.github.io/Coinsight/) |
